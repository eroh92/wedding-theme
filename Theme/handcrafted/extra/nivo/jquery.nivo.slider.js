 ...
 * 
 * Modified by Ernesto Mendez (http://der-design.com)
 * >> Enhanced default callback functions provided, adding extra parameters to extend functionality.
 *
 */
...
(function($) {
    ...
    var NivoSlider = function(element, options){
		...
		var nivoRun = function(slider, kids, settings, nudge){
			...
			//Trigger the beforeChange callback (now vars.currentSlide can actually be used as an index to retrieve metadata)
			settings.beforeChange.call(this, vars.currentSlide, vars, options);
